  ...
  return (
    <>
      <div className="p-6  flex flex-col items-center justify-center">
        <h2 className="text-4xl playfair-display-font font-bold mb-6 aurora-text">My Services</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
          ...
          {cards.map((card, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 shadow-blue-500/50 hover:shadow-blue-500/100 w-80 aurora-text"
            >
